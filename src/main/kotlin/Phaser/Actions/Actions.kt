...
external fun <G : Array<Phaser.GameObjects.GameObject>> SmootherStep(items: G, property: String, min: Number, max: Number, inc: Boolean? = definedExternally /* null */): G = definedExternally
external fun <G : Array<Phaser.GameObjects.GameObject>> SmoothStep(items: G, property: String, min: Number, max: Number, inc: Boolean? = definedExternally /* null */): G = definedExternally
external fun <G : Array<Phaser.GameObjects.GameObject>> Spread(items: G, property: String, min: Number, max: Number, inc: Boolean? = definedExternally /* null */): G = definedExternally

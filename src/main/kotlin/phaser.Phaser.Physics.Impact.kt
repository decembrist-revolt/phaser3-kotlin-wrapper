...
open external class ImpactBody(world: World, x: Number, y: Number, width: Number, height: Number) : Phaser.Physics.Impact.Components.Acceleration, Phaser.Physics.Impact.Components.BodyScale, Phaser.Physics.Impact.Components.BodyType, Phaser.Physics.Impact.Components.Bounce, Phaser.Physics.Impact.Components.CheckAgainst, Phaser.Physics.Impact.Components.Collides, Phaser.Physics.Impact.Components.Debug, Phaser.Physics.Impact.Components.Friction, Phaser.Physics.Impact.Components.Gravity, Phaser.Physics.Impact.Components.Offset, Phaser.Physics.Impact.Components.SetGameObject, Phaser.Physics.Impact.Components.Velocity {
...
open external class ImpactImage : Phaser.GameObjects.Image, Phaser.Physics.Impact.Components.Acceleration, Phaser.Physics.Impact.Components.BodyScale, Phaser.Physics.Impact.Components.BodyType, Phaser.Physics.Impact.Components.Bounce, Phaser.Physics.Impact.Components.CheckAgainst, Phaser.Physics.Impact.Components.Collides, Phaser.Physics.Impact.Components.Debug, Phaser.Physics.Impact.Components.Friction, Phaser.Physics.Impact.Components.Gravity, Phaser.Physics.Impact.Components.Offset, Phaser.Physics.Impact.Components.SetGameObject, Phaser.Physics.Impact.Components.Velocity, Phaser.GameObjects.Components.Alpha, Phaser.GameObjects.Components.BlendMode, Phaser.GameObjects.Components.Depth, Phaser.GameObjects.Components.Flip, Phaser.GameObjects.Components.GetBounds, Phaser.GameObjects.Components.Origin, Phaser.GameObjects.Components.Pipeline, Phaser.GameObjects.Components.ScaleMode, Phaser.GameObjects.Components.ScrollFactor, Phaser.GameObjects.Components.Size, Phaser.GameObjects.Components.Texture, Phaser.GameObjects.Components.Tint, Phaser.GameObjects.Components.Transform, Phaser.GameObjects.Components.Visible {
    ...
    override fun setMask(mask: Phaser.Display.Masks.BitmapMask): ImpactImage /* this */ = definedExternally
    override fun setMask(mask: Phaser.Display.Masks.GeometryMask): ImpactImage /* this */ = definedExternally
    ...
    override fun setSizeToFrame(frame: Phaser.Textures.Frame): ImpactImage /* this */ = definedExternally
    ...
    override fun setCrop(x: Phaser.Geom.Rectangle?, y: Number?, width: Number?, height: Number?): ImpactImage /* this */ = definedExternally
...
open external class ImpactSprite : Phaser.GameObjects.Sprite, Phaser.Physics.Impact.Components.Acceleration, Phaser.Physics.Impact.Components.BodyScale, Phaser.Physics.Impact.Components.BodyType, Phaser.Physics.Impact.Components.Bounce, Phaser.Physics.Impact.Components.CheckAgainst, Phaser.Physics.Impact.Components.Collides, Phaser.Physics.Impact.Components.Debug, Phaser.Physics.Impact.Components.Friction, Phaser.Physics.Impact.Components.Gravity, Phaser.Physics.Impact.Components.Offset, Phaser.Physics.Impact.Components.SetGameObject, Phaser.Physics.Impact.Components.Velocity, Phaser.GameObjects.Components.Alpha, Phaser.GameObjects.Components.BlendMode, Phaser.GameObjects.Components.Depth, Phaser.GameObjects.Components.Flip, Phaser.GameObjects.Components.GetBounds, Phaser.GameObjects.Components.Origin, Phaser.GameObjects.Components.Pipeline, Phaser.GameObjects.Components.ScaleMode, Phaser.GameObjects.Components.ScrollFactor, Phaser.GameObjects.Components.Size, Phaser.GameObjects.Components.Texture, Phaser.GameObjects.Components.Tint, Phaser.GameObjects.Components.Transform, Phaser.GameObjects.Components.Visible {
    constructor(world: World, x: Number, y: Number, texture: String, frame: String? = definedExternally /* null */)
    constructor(world: World, x: Number, y: Number, texture: String, frame: Number? = definedExternally /* null */)
    ...
    override fun getBottomRight(output: Vector2?, includeParent: Boolean?): Vector2
    override fun getBounds(output: Phaser.Geom.Rectangle?): Phaser.Geom.Rectangle
    override fun setMask(mask: Phaser.Display.Masks.BitmapMask): ImpactSprite /* this */ = definedExternally
    override fun setMask(mask: Phaser.Display.Masks.GeometryMask): ImpactSprite /* this */ = definedExternally
    ...
    override fun setSizeToFrame(frame: Phaser.Textures.Frame): ImpactSprite /* this */ = definedExternally
    ...
    override fun setCrop(x: Phaser.Geom.Rectangle?, y: Number?, width: Number?, height: Number?): ImpactSprite /* this */ = definedExternally
...
open external class World(scene: Phaser.Scene, config: Phaser.Physics.Impact.WorldConfig) : Phaser.Events.EventEmitter {
    open var scene: Phaser.Scene = definedExternally

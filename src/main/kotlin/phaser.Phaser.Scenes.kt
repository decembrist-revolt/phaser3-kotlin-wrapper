...
open external class SceneManager(game: Phaser.Game, sceneConfig: Any) {
    ...
    open fun add(key: String, sceneConfig: Phaser.Scenes.Settings.Config, autoStart: Boolean? = definedExternally /* null */, data: Any? = definedExternally /* null */): Phaser.Scene = definedExternally
...
open external class Systems {
    ...
    constructor(scene: Phaser.Scene, config: Phaser.Scenes.Settings.Config)
    open var scene: Phaser.Scene = definedExternally
    open var game: Phaser.Game = definedExternally
    open var facebook: Any = definedExternally

...
open external class BaseSound(manager: BaseSoundManager, key: String, config: SoundConfig? = definedExternally /* null */) : Phaser.Events.EventEmitter {
...
open external class BaseSoundManager(game: Phaser.Game) : Phaser.Events.EventEmitter {
    open var game: Phaser.Game = definedExternally
    open var jsonCache: Phaser.Cache.BaseCache = definedExternally

...
open external class KeyboardPlugin(sceneInputPlugin: Phaser.Input.InputPlugin) : Phaser.Events.EventEmitter {
    ...
    open fun createCursorKeys(): Phaser.Input.Keyboard.CursorKeys = definedExternally

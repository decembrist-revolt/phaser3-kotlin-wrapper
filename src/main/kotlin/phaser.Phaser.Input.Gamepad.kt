...
open external class Gamepad(manager: GamepadPlugin, pad: Pad) : Phaser.Events.EventEmitter {
    ...
    open var leftStick: Phaser.Math.Vector2 = definedExternally
    open var rightStick: Phaser.Math.Vector2 = definedExternally
...
open external class GamepadPlugin(sceneInputPlugin: Phaser.Input.InputPlugin) : Phaser.Events.EventEmitter {
    open var scene: Phaser.Scene = definedExternally
    open var settings: Phaser.Scenes.Settings.Object = definedExternally
    open var sceneInputPlugin: Phaser.Input.InputPlugin = definedExternally

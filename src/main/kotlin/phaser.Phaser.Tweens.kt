...
import TweenDataGenConfig

open external class Timeline(manager: TweenManager) : Phaser.Events.EventEmitter {
...
open external class Tween {
    ...
    open var data: Array<Phaser.Tweens.TweenDataConfig>

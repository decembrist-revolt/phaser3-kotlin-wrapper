...
open external class DynamicTilemapLayer : Phaser.GameObjects.GameObject, Phaser.GameObjects.Components.Alpha, Phaser.GameObjects.Components.BlendMode, Phaser.GameObjects.Components.ComputedSize, Phaser.GameObjects.Components.Depth, Phaser.GameObjects.Components.Flip, Phaser.GameObjects.Components.GetBounds, Phaser.GameObjects.Components.Origin, Phaser.GameObjects.Components.Pipeline, Phaser.GameObjects.Components.ScaleMode, Phaser.GameObjects.Components.ScrollFactor, Phaser.GameObjects.Components.Transform, Phaser.GameObjects.Components.Visible {
    ...
    open fun createFromTiles(indexes: Number, replacements: Number, spriteConfig: GameObjectConfig /* GameObjectConfig & `T$11` */, scene: Phaser.Scene? = definedExternally /* null */, camera: Phaser.Cameras.Scene2D.Camera? = definedExternally /* null */): Array<Phaser.GameObjects.Sprite> = definedExternally
    open fun createFromTiles(indexes: Number, replacements: Array<Any>, spriteConfig: GameObjectConfig /* GameObjectConfig & `T$11` */, scene: Phaser.Scene? = definedExternally /* null */, camera: Phaser.Cameras.Scene2D.Camera? = definedExternally /* null */): Array<Phaser.GameObjects.Sprite> = definedExternally
    open fun createFromTiles(indexes: Array<Any>, replacements: Number, spriteConfig: GameObjectConfig /* GameObjectConfig & `T$11` */, scene: Phaser.Scene? = definedExternally /* null */, camera: Phaser.Cameras.Scene2D.Camera? = definedExternally /* null */): Array<Phaser.GameObjects.Sprite> = definedExternally
    open fun createFromTiles(indexes: Array<Any>, replacements: Array<Any>, spriteConfig: GameObjectConfig /* GameObjectConfig & `T$11` */, scene: Phaser.Scene? = definedExternally /* null */, camera: Phaser.Cameras.Scene2D.Camera? = definedExternally /* null */): Array<Phaser.GameObjects.Sprite> = definedExternally
    ...
    open fun removeTileAtWorldXY(worldX: Number, worldY: Number, replaceWithNull: Boolean? = definedExternally /* null */, recalculateFaces: Boolean? = definedExternally /* null */, camera: Phaser.Cameras.Scene2D.Camera? = definedExternally /* null */): Tile = definedExternally
...
open external class StaticTilemapLayer : Phaser.GameObjects.GameObject, Phaser.GameObjects.Components.Alpha, Phaser.GameObjects.Components.BlendMode, Phaser.GameObjects.Components.ComputedSize, Phaser.GameObjects.Components.Depth, Phaser.GameObjects.Components.Flip, Phaser.GameObjects.Components.GetBounds, Phaser.GameObjects.Components.Origin, Phaser.GameObjects.Components.Pipeline, Phaser.GameObjects.Components.ScaleMode, Phaser.GameObjects.Components.Transform, Phaser.GameObjects.Components.Visible, Phaser.GameObjects.Components.ScrollFactor {
    constructor(scene: Phaser.Scene, tilemap: Tilemap, layerIndex: Number, tileset: String, x: Number? = definedExternally /* null */, y: Number? = definedExternally /* null */)
    constructor(scene: Phaser.Scene, tilemap: Tilemap, layerIndex: Number, tileset: Array<String>, x: Number? = definedExternally /* null */, y: Number? = definedExternally /* null */)
    constructor(scene: Phaser.Scene, tilemap: Tilemap, layerIndex: Number, tileset: Tileset, x: Number? = definedExternally /* null */, y: Number? = definedExternally /* null */)
    constructor(scene: Phaser.Scene, tilemap: Tilemap, layerIndex: Number, tileset: Array<Tileset>, x: Number? = definedExternally /* null */, y: Number? = definedExternally /* null */)
    ...
    override var scrollFactorX: Number
    override var scrollFactorY: Number
    open fun upload(camera: Phaser.Cameras.Scene2D.Camera, tilesetIndex: Number): StaticTilemapLayer = definedExternally
...
open external class Tile(layer: LayerData, index: Number, x: Number, y: Number, width: Number, height: Number, baseWidth: Number, baseHeight: Number) : Phaser.GameObjects.Components.Alpha, Phaser.GameObjects.Components.Flip, Phaser.GameObjects.Components.Visible {
...
open external class Tilemap(scene: Phaser.Scene, mapData: MapData) {
    ...
    open fun createFromObjects(name: String, id: String, spriteConfig: GameObjectConfig /* GameObjectConfig & `T$11` */, scene: Phaser.Scene? = definedExternally /* null */): Array<Phaser.GameObjects.Sprite> = definedExternally
    open fun createFromObjects(name: String, id: Number, spriteConfig: GameObjectConfig /* GameObjectConfig & `T$11` */, scene: Phaser.Scene? = definedExternally /* null */): Array<Phaser.GameObjects.Sprite> = definedExternally
    open fun createFromTiles(indexes: Number, replacements: Number, spriteConfig: GameObjectConfig /* GameObjectConfig & `T$11` */, scene: Phaser.Scene? = definedExternally /* null */, camera: Phaser.Cameras.Scene2D.Camera? = definedExternally /* null */, layer: LayerData? = definedExternally /* null */): Array<Phaser.GameObjects.Sprite> = definedExternally
    ...
    open fun removeTileAtWorldXY(worldX: Number, worldY: Number, replaceWithNull: Boolean? = definedExternally /* null */, recalculateFaces: Boolean? = definedExternally /* null */, camera: Phaser.Cameras.Scene2D.Camera? = definedExternally /* null */, layer: LayerData? = definedExternally /* null */): Tile = definedExternally

...
external interface Animation {
    ...
    fun playReverse(key: String, ignoreIfPlaying: Boolean? = definedExternally /* null */, startFrame: Number? = definedExternally /* null */): Phaser.GameObjects.GameObject
    fun _startAnimation(key: String, startFrame: Number? = definedExternally /* null */): Phaser.GameObjects.GameObject
    fun reverse(key: String): Phaser.GameObjects.GameObject
    fun getProgress(): Number
    fun setProgress(value: Number? = definedExternally /* null */): Phaser.GameObjects.GameObject
    fun remove(key: String? = definedExternally /* null */, animation: Phaser.Animations.Animation? = definedExternally /* null */)
...
external interface Crop {
    ...
    fun setCrop(x: Phaser.Geom.Rectangle? = definedExternally /* null */, y: Number? = definedExternally /* null */, width: Number? = definedExternally /* null */, height: Number? = definedExternally /* null */): Crop /* this */
...
external interface GetBounds {
    ...
    fun <O : Rectangle> getBounds(output: O? = definedExternally /* null */): O
    ...
    fun getBounds(output: Rectangle? = definedExternally /* null */): Rectangle
}
external interface Mask {
    var mask: dynamic /* Phaser.Display.Masks.BitmapMask | Phaser.Display.Masks.GeometryMask */
    fun setMask(mask: Phaser.Display.Masks.BitmapMask): Mask /* this */
    fun setMask(mask: Phaser.Display.Masks.GeometryMask): Mask /* this */
    fun clearMask(destroyMask: Boolean? = definedExternally /* null */): Mask /* this */
    fun createBitmapMask(renderable: Phaser.GameObjects.GameObject? = definedExternally /* null */): Phaser.Display.Masks.BitmapMask
    fun createGeometryMask(graphics: Phaser.GameObjects.Graphics? = definedExternally /* null */): Phaser.Display.Masks.GeometryMask
}
...
external interface Size {
    ...
    var displayWidth: Number
    var displayHeight: Number
    fun setSizeToFrame(frame: Phaser.Textures.Frame): Size /* this */
...
external interface TextureCrop {
    ...
    fun setCrop(x: Phaser.Geom.Rectangle? = definedExternally /* null */, y: Number? = definedExternally /* null */, width: Number? = definedExternally /* null */, height: Number? = definedExternally /* null */): TextureCrop /* this */
...
open external class TransformMatrix(a: Number? = definedExternally /* null */, b: Number? = definedExternally /* null */, c: Number? = definedExternally /* null */, d: Number? = definedExternally /* null */, tx: Number? = definedExternally /* null */, ty: Number? = definedExternally /* null */) {
    ...
    open fun applyInverse(x: Number, y: Number, output: Phaser.Math.Vector2? = definedExternally /* null */): Phaser.Math.Vector2 = definedExternally

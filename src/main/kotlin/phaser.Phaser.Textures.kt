...
import SpriteSheetConfig
import SpriteSheetFromAtlasConfig
...
open external class CanvasTexture(manager: CanvasTexture, key: String, source: HTMLCanvasElement, width: Number, height: Number) : Texture {
    ...
    open fun getPixel(x: Number, y: Number, out: Phaser.Display.PhaserColor? = definedExternally /* null */): Phaser.Display.PhaserColor = definedExternally
...
open external class TextureManager(game: Phaser.Game) : Phaser.Events.EventEmitter {
    ...
    open fun addRenderTexture(key: String, renderTexture: Phaser.GameObjects.RenderTexture): Texture = definedExternally
    ...
    open fun getPixel(x: Number, y: Number, key: String, frame: String): Phaser.Display.PhaserColor = definedExternally
    open fun getPixel(x: Number, y: Number, key: String, frame: Number): Phaser.Display.PhaserColor = definedExternally

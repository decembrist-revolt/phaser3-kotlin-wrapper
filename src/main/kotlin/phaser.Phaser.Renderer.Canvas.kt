...
open external class CanvasRenderer(game: Phaser.Game) {
    ...
    open fun render(scene: Phaser.Scene, children: Phaser.GameObjects.DisplayList, interpolationPercentage: Number, camera: Phaser.Cameras.Scene2D.Camera): Unit = definedExternally
    ...
    open fun batchSprite(sprite: Phaser.GameObjects.GameObject, frame: Phaser.Textures.Frame, camera: Phaser.Cameras.Scene2D.Camera, parentTransformMatrix: Phaser.GameObjects.Components.TransformMatrix? = definedExternally /* null */): Unit = definedExternally
    open fun destroy(): Unit = definedExternally
}
external fun GetBlendModes(): Array<Any> = definedExternally
external fun SetTransform(renderer: CanvasRenderer, ctx: CanvasRenderingContext2D, src: Phaser.GameObjects.GameObject, camera: Phaser.Cameras.Scene2D.Camera, parentMatrix: Phaser.GameObjects.Components.TransformMatrix? = definedExternally /* null */): Boolean = definedExternally

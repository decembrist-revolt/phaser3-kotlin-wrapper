...
external fun AssignTileProperties(mapData: Phaser.Tilemaps.MapData): Unit = definedExternally
external fun Base64Decode(data: Any): Array<Any> = definedExternally
external fun BuildTilesetIndex(mapData: Phaser.Tilemaps.MapData): Array<Any> = definedExternally
external fun ParseGID(gid: Number): Any = definedExternally
external fun ParseImageLayers(json: Any): Array<Any> = definedExternally
external fun ParseJSONTiled(name: String, json: Any, insertNull: Boolean): Phaser.Tilemaps.MapData = definedExternally

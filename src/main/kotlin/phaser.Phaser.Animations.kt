...
import AnimationFrameConfig
import GenerateFrameNamesConfig
import GenerateFrameNumbersConfig
import JSONAnimation
import JSONAnimationFrame
import JSONAnimationManager
...
open external class AnimationManager(game: Phaser.Game) : Phaser.Events.EventEmitter {
    ...
    open fun play(key: String, child: Array<Phaser.GameObjects.GameObject>): AnimationManager = definedExternally
    open fun remove(key: String): Animation = definedExternally
    open fun resumeAll(): AnimationManager = definedExternally
    open fun <G : Array<Phaser.GameObjects.GameObject>> staggerPlay(key: String, children: Phaser.GameObjects.GameObject, stagger: Number? = definedExternally /* null */): G = definedExternally

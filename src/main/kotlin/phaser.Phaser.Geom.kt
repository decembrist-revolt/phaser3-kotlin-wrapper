...
open external class Circle(x: Number? = definedExternally /* null */, y: Number? = definedExternally /* null */, radius: Number? = definedExternally /* null */) {
...
open external class Ellipse(x: Number? = definedExternally /* null */, y: Number? = definedExternally /* null */, width: Number? = definedExternally /* null */, height: Number? = definedExternally /* null */) {
    open var x: Number = definedExternally
    open var y: Number = definedExternally
...
open external class Line(x1: Number? = definedExternally /* null */, y1: Number? = definedExternally /* null */, x2: Number? = definedExternally /* null */, y2: Number? = definedExternally /* null */) {
...
open external class Point(x: Number? = definedExternally /* null */, y: Number? = definedExternally /* null */) {
    open var x: Number = definedExternally
    open var y: Number = definedExternally
...
open external class Polygon(points: Array<Point>? = definedExternally /* null */) {
    ...
    companion object {
        ...
        fun GetPoints(polygon: Polygon, quantity: Number, stepRate: Number? = definedExternally /* null */, output: Array<Any>? = definedExternally /* null */): Array<Point> = definedExternally
        fun Perimeter(polygon: Polygon): Number = definedExternally
        fun <O : Polygon> Reverse(polygon: O): O = definedExternally
        fun <O : Polygon> Smooth(polygon: O): O = definedExternally
    }
}
open external class Rectangle(x: Number? = definedExternally /* null */, y: Number? = definedExternally /* null */, width: Number? = definedExternally /* null */, height: Number? = definedExternally /* null */) {
    open var x: Number = definedExternally
    open var y: Number = definedExternally
    open var width: Number = definedExternally
    open var height: Number = definedExternally
    ...
    companion object {
        ...
        fun <O : Rectangle> Intersection(rectA: Rectangle, rectB: Rectangle, out: Rectangle? = definedExternally /* null */): O = definedExternally
        ...
        fun <O : Rectangle> OffsetPoint(rect: O, point: Phaser.Math.Vector2): O = definedExternally
        ...
        fun <O : Point> RandomOutside(outer: Rectangle, inner: Rectangle, out: O? = definedExternally /* null */): O = definedExternally
...
open external class Triangle(x1: Number? = definedExternally /* null */, y1: Number? = definedExternally /* null */, x2: Number? = definedExternally /* null */, y2: Number? = definedExternally /* null */, x3: Number? = definedExternally /* null */, y3: Number? = definedExternally /* null */) {
    open var x1: Number = definedExternally
    open var y1: Number = definedExternally
    open var x2: Number = definedExternally
    open var y2: Number = definedExternally

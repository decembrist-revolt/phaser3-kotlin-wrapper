...
open external class BaseCamera(x: Number, y: Number, width: Number, height: Number) : Phaser.Events.EventEmitter, Phaser.GameObjects.Components.Alpha, Phaser.GameObjects.Components.Visible {
    ...
    open var sceneManager: Phaser.Scenes.SceneManager = definedExternally
    ...
    open var worldView: Phaser.Geom.Rectangle = definedExternally
    open var dirty: Boolean = definedExternally
    open var transparent: Boolean = definedExternally
    open var backgroundColor: Phaser.Display.PhaserColor = definedExternally
    override var alpha: Number = definedExternally
    open var disableCull: Boolean = definedExternally
    open var midPoint: Phaser.Math.Vector2 = definedExternally
    ...
    open fun getScroll(x: Number, y: Number, out: Phaser.Math.Vector2? = definedExternally /* null */): Phaser.Math.Vector2 = definedExternally
    ...
    open fun ignore(entries: Phaser.GameObjects.GameObject): BaseCamera = definedExternally
    open fun ignore(entries: Array<Phaser.GameObjects.GameObject>): BaseCamera = definedExternally
    open fun ignore(entries: Phaser.GameObjects.Group): BaseCamera = definedExternally
...
open external class Camera(x: Number, y: Number, width: Number, height: Number) : BaseCamera, Phaser.GameObjects.Components.Flip, Phaser.GameObjects.Components.Tint {
    ...
    open var panEffect: Phaser.Cameras.Scene2D.Effects.Pan = definedExternally
    open var zoomEffect: Phaser.Cameras.Scene2D.Effects.Zoom = definedExternally
    open var lerp: Phaser.Math.Vector2 = definedExternally
    open var followOffset: Phaser.Math.Vector2 = definedExternally
    open var deadzone: Phaser.Geom.Rectangle = definedExternally
    ...
    open fun setRenderToTexture(pipeline: Phaser.Renderer.WebGL.WebGLPipeline? = definedExternally /* null */): Camera = definedExternally
    open fun setPipeline(pipeline: String? = definedExternally /* null */): Camera = definedExternally
    open fun setPipeline(pipeline: Phaser.Renderer.WebGL.WebGLPipeline? = definedExternally /* null */): Camera = definedExternally
    ...
    open fun startFollow(target: Phaser.GameObjects.GameObject, roundPixels: Boolean? = definedExternally /* null */, lerpX: Number? = definedExternally /* null */, lerpY: Number? = definedExternally /* null */, offsetX: Number? = definedExternally /* null */, offsetY: Number? = definedExternally /* null */): Camera /* this */ = definedExternally
...
open external class CameraManager(scene: Phaser.Scene) {
    ...
    open fun getCamerasBelowPointer(pointer: Phaser.Input.Pointer): Array<Camera> = definedExternally

...
import EllipseCurveConfig
import JSONCurve
import JSONEllipseCurve
import JSONPath
...
open external class CubicBezier : Curve {
    ...
    open var p0: Phaser.Math.Vector2
    open var p1: Phaser.Math.Vector2
    open var p2: Phaser.Math.Vector2
    open var p3: Phaser.Math.Vector2
    override fun <O : Phaser.Math.Vector2> getStartPoint(out: O? /* null */): O = definedExternally
    ...
    override fun <G : Phaser.GameObjects.Graphics> draw(graphics: G, pointsTotal: Number? /* null */): G = definedExternally
...
open external class Curve(type: String) {
    ...
    open fun getEndPoint(out: Phaser.Math.Vector2? = definedExternally /* null */): Phaser.Math.Vector2 = definedExternally
...
open external class Line : Curve {
    ...
    open fun <O : Phaser.Math.Vector2> getPoint(t: Number, out: O? = definedExternally /* null */): O = definedExternally
    override fun <O : Phaser.Math.Vector2> getPointAt(u: Number, out: O? /* null */): O = definedExternally
...
open external class Path(x: Number? = definedExternally /* null */, y: Number? = definedExternally /* null */) {
    ...
    open fun cubicBezierTo(x: Number, y: Number, control1X: Phaser.Math.Vector2, control1Y: Number? = definedExternally /* null */, control2X: Number? = definedExternally /* null */, control2Y: Number? = definedExternally /* null */): Path = definedExternally
    open fun cubicBezierTo(x: Number, y: Phaser.Math.Vector2, control1X: Number, control1Y: Number? = definedExternally /* null */, control2X: Number? = definedExternally /* null */, control2Y: Number? = definedExternally /* null */): Path = definedExternally
    open fun cubicBezierTo(x: Number, y: Phaser.Math.Vector2, control1X: Phaser.Math.Vector2, control1Y: Number? = definedExternally /* null */, control2X: Number? = definedExternally /* null */, control2Y: Number? = definedExternally /* null */): Path = definedExternally
    open fun cubicBezierTo(x: Phaser.Math.Vector2, y: Number, control1X: Number, control1Y: Number? = definedExternally /* null */, control2X: Number? = definedExternally /* null */, control2Y: Number? = definedExternally /* null */): Path = definedExternally
    open fun cubicBezierTo(x: Phaser.Math.Vector2, y: Number, control1X: Phaser.Math.Vector2, control1Y: Number? = definedExternally /* null */, control2X: Number? = definedExternally /* null */, control2Y: Number? = definedExternally /* null */): Path = definedExternally
    open fun cubicBezierTo(x: Phaser.Math.Vector2, y: Phaser.Math.Vector2, control1X: Number, control1Y: Number? = definedExternally /* null */, control2X: Number? = definedExternally /* null */, control2Y: Number? = definedExternally /* null */): Path = definedExternally
    open fun cubicBezierTo(x: Phaser.Math.Vector2, y: Phaser.Math.Vector2, control1X: Phaser.Math.Vector2, control1Y: Number? = definedExternally /* null */, control2X: Number? = definedExternally /* null */, control2Y: Number? = definedExternally /* null */): Path = definedExternally
...
open external class Spline(points: Array<Phaser.Math.Vector2>? = definedExternally /* null */) : Curve {
    ...
    open fun addPoints(points: Array<Phaser.Math.Vector2>): Spline = definedExternally

...
open external class BitmapMaskPipeline(config: Any) : Phaser.Renderer.WebGL.WebGLPipeline {
...
open external class ForwardDiffuseLightPipeline(config: Any) : TextureTintPipeline {
    override fun onRender(scene: Phaser.Scene, camera: Phaser.Cameras.Scene2D.Camera): ForwardDiffuseLightPipeline /* this */ = definedExternally
    open fun setNormalMap(gameObject: Phaser.GameObjects.GameObject): Unit = definedExternally
...
open external class TextureTintPipeline(config: Any) : Phaser.Renderer.WebGL.WebGLPipeline {
    ...
    open fun batchSprite(sprite: Phaser.GameObjects.Sprite, camera: Phaser.Cameras.Scene2D.Camera, parentTransformMatrix: Phaser.GameObjects.Components.TransformMatrix? = definedExternally /* null */): Unit = definedExternally
    open fun batchSprite(sprite: Phaser.GameObjects.Image, camera: Phaser.Cameras.Scene2D.Camera, parentTransformMatrix: Phaser.GameObjects.Components.TransformMatrix? = definedExternally /* null */): Unit = definedExternally
    ...
    open fun batchTextureFrame(frame: Phaser.Textures.Frame, x: Number, y: Number, tint: Number, alpha: Number, transformMatrix: Phaser.GameObjects.Components.TransformMatrix, parentTransformMatrix: Phaser.GameObjects.Components.TransformMatrix? = definedExternally /* null */): Unit = definedExternally
    open fun drawFillRect(x: Number, y: Number, width: Number, height: Number, color: Number, alpha: Number): Unit = definedExternally
    open fun batchFillRect(x: Number, y: Number, width: Number, height: Number, currentMatrix: Phaser.GameObjects.Components.TransformMatrix, parentMatrix: Phaser.GameObjects.Components.TransformMatrix): Unit = definedExternally
    open fun batchFillTriangle(x0: Number, y0: Number, x1: Number, y1: Number, x2: Number, y2: Number, currentMatrix: Phaser.GameObjects.Components.TransformMatrix, parentMatrix: Phaser.GameObjects.Components.TransformMatrix): Unit = definedExternally
    open fun batchStrokeTriangle(x0: Number, y0: Number, x1: Number, y1: Number, x2: Number, y2: Number, lineWidth: Number, currentMatrix: Phaser.GameObjects.Components.TransformMatrix, parentMatrix: Phaser.GameObjects.Components.TransformMatrix): Unit = definedExternally
    open fun batchFillPath(path: Array<Any>, currentMatrix: Phaser.GameObjects.Components.TransformMatrix, parentMatrix: Phaser.GameObjects.Components.TransformMatrix): Unit = definedExternally
    open fun batchStrokePath(path: Array<Any>, lineWidth: Number, pathOpen: Boolean, currentMatrix: Phaser.GameObjects.Components.TransformMatrix, parentMatrix: Phaser.GameObjects.Components.TransformMatrix): Unit = definedExternally

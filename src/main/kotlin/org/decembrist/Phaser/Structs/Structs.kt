...
@file:[JsModule("phaser") JsQualifier("Structs") JsNonModule]
package org.decembrist.Phaser.Structs
...
open external class List<T>(parent: Any) {
    ...
    open fun each(callback: (item: Any, args: Any) -> Unit, context: Any? = definedExternally /* null */, vararg args: Any): Unit = definedExternally
...
open external class Map<K, V>(elements: Array<V>) {
    open var entries: `T$10` = definedExternally
...
open external class ProcessQueue<T> {
...
open external class Set<T>(elements: Array<T>? = definedExternally /* null */) {

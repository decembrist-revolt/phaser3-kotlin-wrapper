...
package org.decembrist.Phaser.Tweens

import org.decembrist.Phaser.Phaser
import org.decembrist.utils.TweenDataGenConfig

open external class Timeline(manager: TweenManager) : org.decembrist.Phaser.Events.EventEmitter {
...
open external class Tween {
    constructor(parent: TweenManager, data: Array<org.decembrist.Phaser.Tweens.TweenDataConfig>, targets: Array<Any>)
    constructor(parent: Timeline, data: Array<org.decembrist.Phaser.Tweens.TweenDataConfig>, targets: Array<Any>)

    open var parent: dynamic /* TweenManager | Timeline */
    open var parentIsTimeline: Boolean
    open var data: Array<org.decembrist.Phaser.Tweens.TweenDataConfig>
    ...
    open fun update(timestamp: Number, delta: Number): Boolean = definedExternally
    open fun setStateFromEnd(tween: Tween, tweenData: org.decembrist.Phaser.Tweens.TweenDataConfig, diff: Number): Number = definedExternally
    open fun setStateFromStart(tween: Tween, tweenData: org.decembrist.Phaser.Tweens.TweenDataConfig, diff: Number): Number = definedExternally
    open fun updateTweenData(tween: Tween, tweenData: org.decembrist.Phaser.Tweens.TweenDataConfig, delta: Number): Boolean = definedExternally
}
...
external fun TweenData(target: Any, key: String, getEnd: Function<*>, getStart: Function<*>, ease: Function<*>, delay: Number, duration: Number, yoyo: Boolean, hold: Number, repeat: Number, repeatDelay: Number, flipX: Boolean, flipY: Boolean): org.decembrist.Phaser.Tweens.TweenDataConfig = definedExternally

...
open external class Matrix3(m: Matrix3? = definedExternally /* null */) {
...
open external class Matrix4(m: Matrix4? = definedExternally /* null */) {
    open var `val`: Float32Array = definedExternally
...
open external class Quaternion(x: Number? = definedExternally /* null */, y: Number? = definedExternally /* null */, z: Number? = definedExternally /* null */, w: Number? = definedExternally /* null */) {
...
external fun RandomXY(vector: Vector2, scale: Number? = definedExternally /* null */): Vector2 = definedExternally
...
external fun Rotate(point: Any?, angle: Number): Geom.Point = definedExternally
external fun Rotate(point: Geom.Point, angle: Number): Geom.Point = definedExternally
external fun RotateAround(point: Any?, x: Number, y: Number, angle: Number): Geom.Point = definedExternally
external fun RotateAround(point: Geom.Point, x: Number, y: Number, angle: Number): Geom.Point = definedExternally
external fun RotateAroundDistance(point: Any?, x: Number, y: Number, angle: Number, distance: Number): Geom.Point = definedExternally
external fun RotateAroundDistance(point: Geom.Point, x: Number, y: Number, angle: Number, distance: Number): Geom.Point = definedExternally
...
external fun SinCosTableGenerator(length: Number, sinAmp: Number? = definedExternally /* null */, cosAmp: Number? = definedExternally /* null */, frequency: Number? = definedExternally /* null */): SinCosTable = definedExternally
...
external fun TransformXY(x: Number, y: Number, positionX: Number, positionY: Number, rotation: Number, scaleX: Number, scaleY: Number, output: Geom.Point? = definedExternally /* null */): dynamic /* Any? | Vector2 | Phaser.Geom.Point */ = definedExternally
...
open external class Vector3(x: Number? = definedExternally /* null */, y: Number? = definedExternally /* null */, z: Number? = definedExternally /* null */) {
    open var x: Number = definedExternally
    open var y: Number = definedExternally
    open var z: Number = definedExternally
...
open external class Vector4(x: Number? = definedExternally /* null */, y: Number? = definedExternally /* null */, z: Number? = definedExternally /* null */, w: Number? = definedExternally /* null */) {
    open var x: Number = definedExternally
    open var y: Number = definedExternally
    open var z: Number = definedExternally
    open var w: Number = definedExternally

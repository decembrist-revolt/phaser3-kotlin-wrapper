...
open external class CubicBezier : Curve {
    constructor(p0: org.decembrist.Phaser.Math.Vector2, p1: org.decembrist.Phaser.Math.Vector2, p2: org.decembrist.Phaser.Math.Vector2, p3: org.decembrist.Phaser.Math.Vector2)
    constructor(p0: Array<org.decembrist.Phaser.Math.Vector2>, p1: org.decembrist.Phaser.Math.Vector2, p2: org.decembrist.Phaser.Math.Vector2, p3: org.decembrist.Phaser.Math.Vector2)
    open var p0: org.decembrist.Phaser.Math.Vector2
    open var p1: org.decembrist.Phaser.Math.Vector2
    open var p2: org.decembrist.Phaser.Math.Vector2
    open var p3: org.decembrist.Phaser.Math.Vector2
    override fun <O : org.decembrist.Phaser.Math.Vector2> getStartPoint(out: O? /* null */): O = definedExternally
    open fun getResolution(divisions: Number): Number = definedExternally
    open fun <O : org.decembrist.Phaser.Math.Vector2> getPoint(t: Number, out: O? = definedExternally /* null */): O = definedExternally
...
open external class Curve(type: String) {
    ...
    open fun getEndPoint(out: org.decembrist.Phaser.Math.Vector2? = definedExternally /* null */): org.decembrist.Phaser.Math.Vector2 = definedExternally
    ...
    open fun <O : org.decembrist.Phaser.Math.Vector2> getPointAt(u: Number, out: O? = definedExternally /* null */): O = definedExternally
    open fun getPoints(divisions: Number? = definedExternally /* null */): Array<org.decembrist.Phaser.Math.Vector2> = definedExternally
    open fun <O : org.decembrist.Phaser.Math.Vector2> getRandomPoint(out: O? = definedExternally /* null */): O = definedExternally
    open fun getSpacedPoints(divisions: Number? = definedExternally /* null */): Array<org.decembrist.Phaser.Math.Vector2> = definedExternally
    open fun <O : org.decembrist.Phaser.Math.Vector2> getStartPoint(out: O? = definedExternally /* null */): O = definedExternally
    open fun <O : org.decembrist.Phaser.Math.Vector2> getTangent(t: Number, out: O? = definedExternally /* null */): O = definedExternally
    open fun <O : org.decembrist.Phaser.Math.Vector2> getTangentAt(u: Number, out: O? = definedExternally /* null */): O = definedExternally
...
open external class Line : Curve {
    constructor(p0: Array<Number>, p1: org.decembrist.Phaser.Math.Vector2? = definedExternally /* null */)
    constructor(p0: org.decembrist.Phaser.Math.Vector2, p1: org.decembrist.Phaser.Math.Vector2? = definedExternally /* null */)
    open var p0: org.decembrist.Phaser.Math.Vector2
    open var p1: org.decembrist.Phaser.Math.Vector2
    ...
    open fun <O : org.decembrist.Phaser.Math.Vector2> getPoint(t: Number, out: O? = definedExternally /* null */): O = definedExternally
    override fun <O : org.decembrist.Phaser.Math.Vector2> getPointAt(u: Number, out: O? /* null */): O = definedExternally
    open fun <O : org.decembrist.Phaser.Math.Vector2> getTangent(): O = definedExternally
...
open external class MoveTo(x: Number? = definedExternally /* null */, y: Number? = definedExternally /* null */) {
    open var active: Boolean = definedExternally
    open var p0: org.decembrist.Phaser.Math.Vector2 = definedExternally
    open fun <O : org.decembrist.Phaser.Math.Vector2> getPoint(t: Number, out: O? = definedExternally /* null */): O = definedExternally
    open fun <O : org.decembrist.Phaser.Math.Vector2> getPointAt(u: Number, out: O? = definedExternally /* null */): O = definedExternally
...
open external class Path(x: Number? = definedExternally /* null */, y: Number? = definedExternally /* null */) {
    ...
    open var startPoint: org.decembrist.Phaser.Math.Vector2 = definedExternally
    ...
    open fun cubicBezierTo(x: Number, y: Number, control1X: org.decembrist.Phaser.Math.Vector2, control1Y: Number? = definedExternally /* null */, control2X: Number? = definedExternally /* null */, control2Y: Number? = definedExternally /* null */): Path = definedExternally
    open fun cubicBezierTo(x: Number, y: org.decembrist.Phaser.Math.Vector2, control1X: Number, control1Y: Number? = definedExternally /* null */, control2X: Number? = definedExternally /* null */, control2Y: Number? = definedExternally /* null */): Path = definedExternally
    open fun cubicBezierTo(x: Number, y: org.decembrist.Phaser.Math.Vector2, control1X: org.decembrist.Phaser.Math.Vector2, control1Y: Number? = definedExternally /* null */, control2X: Number? = definedExternally /* null */, control2Y: Number? = definedExternally /* null */): Path = definedExternally
    open fun cubicBezierTo(x: org.decembrist.Phaser.Math.Vector2, y: Number, control1X: Number, control1Y: Number? = definedExternally /* null */, control2X: Number? = definedExternally /* null */, control2Y: Number? = definedExternally /* null */): Path = definedExternally
    open fun cubicBezierTo(x: org.decembrist.Phaser.Math.Vector2, y: Number, control1X: org.decembrist.Phaser.Math.Vector2, control1Y: Number? = definedExternally /* null */, control2X: Number? = definedExternally /* null */, control2Y: Number? = definedExternally /* null */): Path = definedExternally
    open fun cubicBezierTo(x: org.decembrist.Phaser.Math.Vector2, y: org.decembrist.Phaser.Math.Vector2, control1X: Number, control1Y: Number? = definedExternally /* null */, control2X: Number? = definedExternally /* null */, control2Y: Number? = definedExternally /* null */): Path = definedExternally
    open fun cubicBezierTo(x: org.decembrist.Phaser.Math.Vector2, y: org.decembrist.Phaser.Math.Vector2, control1X: org.decembrist.Phaser.Math.Vector2, control1Y: Number? = definedExternally /* null */, control2X: Number? = definedExternally /* null */, control2Y: Number? = definedExternally /* null */): Path = definedExternally
    ...
    open fun quadraticBezierTo(x: Array<org.decembrist.Phaser.Math.Vector2>, y: Number? = definedExternally /* null */, controlX: Number? = definedExternally /* null */, controlY: Number? = definedExternally /* null */): Path = definedExternally
    ...
    open fun <O : org.decembrist.Phaser.Math.Vector2> getBounds(out: O? = definedExternally /* null */, accuracy: Number? = definedExternally /* null */): O = definedExternally
    open fun getCurveLengths(): Array<Number> = definedExternally
    open fun <O : org.decembrist.Phaser.Math.Vector2> getEndPoint(out: O? = definedExternally /* null */): O = definedExternally
    open fun getLength(): Number = definedExternally
    open fun <O : org.decembrist.Phaser.Math.Vector2> getPoint(t: Number, out: O? = definedExternally /* null */): O = definedExternally
    open fun getPoints(divisions: Number? = definedExternally /* null */): Array<org.decembrist.Phaser.Math.Vector2> = definedExternally
    open fun <O : org.decembrist.Phaser.Math.Vector2> getRandomPoint(out: O? = definedExternally /* null */): O = definedExternally
    ...
    open fun lineTo(x: org.decembrist.Phaser.Math.Vector2, y: Number? = definedExternally /* null */): Path = definedExternally
    open fun splineTo(points: Array<org.decembrist.Phaser.Math.Vector2>): Path = definedExternally
...
open external class QuadraticBezier : Curve {
    constructor(p0: Array<Number>, p1: org.decembrist.Phaser.Math.Vector2, p2: org.decembrist.Phaser.Math.Vector2)
    constructor(p0: org.decembrist.Phaser.Math.Vector2, p1: org.decembrist.Phaser.Math.Vector2, p2: org.decembrist.Phaser.Math.Vector2)
    open var p0: org.decembrist.Phaser.Math.Vector2
    open var p1: org.decembrist.Phaser.Math.Vector2
    open var p2: org.decembrist.Phaser.Math.Vector2
    override fun <O : org.decembrist.Phaser.Math.Vector2> getStartPoint(out: O? /* null */): O = definedExternally
...
open external class Spline(points: Array<org.decembrist.Phaser.Math.Vector2>? = definedExternally /* null */) : Curve {
    open var points: Array<org.decembrist.Phaser.Math.Vector2> = definedExternally
    open fun addPoints(points: Array<Number>): Spline = definedExternally
    open fun addPoints(points: Array<org.decembrist.Phaser.Math.Vector2>): Spline = definedExternally
    open fun addPoints(points: Array<Array<Number>>): Spline = definedExternally
    open fun addPoint(x: Number, y: Number): org.decembrist.Phaser.Math.Vector2 = definedExternally
    override fun <O : org.decembrist.Phaser.Math.Vector2> getStartPoint(out: O? /* null */): O = definedExternally
    open fun getResolution(divisions: Number): Number = definedExternally
    open fun <O : org.decembrist.Phaser.Math.Vector2> getPoint(t: Number, out: O? = definedExternally /* null */): O = definedExternally
    open fun toJSON(): JSONCurve = definedExternally

...
open external class WebGLPipeline(config: Any) {
    ...
    open fun onRender(scene: Phaser.Scene, camera: Phaser.Cameras.Scene2D.Camera): WebGLPipeline /* this */ = definedExternally
...
open external class WebGLRenderer(game: Phaser.Game) {
    ...
    open fun setPipeline(pipelineInstance: WebGLPipeline, gameObject: Phaser.GameObjects.GameObject? = definedExternally /* null */): WebGLPipeline = definedExternally
    ...
    open fun render(scene: Phaser.Scene, children: Phaser.GameObjects.GameObject, interpolationPercentage: Number, camera: Phaser.Cameras.Scene2D.Camera): Unit = definedExternally
